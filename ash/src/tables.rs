...
unsafe impl Send for EntryFnV1_4 {}
unsafe impl Sync for EntryFnV1_4 {}
impl EntryFnV1_4 {
    pub fn load<F: FnMut(&CStr) -> *const c_void>(mut f: F) -> Self {
        Self::load_erased(&mut f)
    }
...
unsafe impl Send for InstanceFnV1_4 {}
unsafe impl Sync for InstanceFnV1_4 {}
impl InstanceFnV1_4 {
    pub fn load<F: FnMut(&CStr) -> *const c_void>(mut f: F) -> Self {
        Self::load_erased(&mut f)
    }
...
#[derive(Clone)]
#[doc = "Raw Vulkan 1.0 entry point function pointers"]
...
#[derive(Clone)]
#[doc = "Raw Vulkan 1.0 instance-level function pointers"]
...
#[derive(Clone)]
#[doc = "Raw Vulkan 1.0 device-level function pointers"]
