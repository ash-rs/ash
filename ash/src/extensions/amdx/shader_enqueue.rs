...
impl crate::amdx::shader_enqueue::Device {
    ...
    pub unsafe fn cmd_initialize_graph_scratch_memory(
        ...
        (self.fp.cmd_initialize_graph_scratch_memory_amdx)(command_buffer, execution_graph, scratch, scratch_size)
    }
    ...
    pub unsafe fn cmd_dispatch_graph_indirect(
        ...
        (self.fp.cmd_dispatch_graph_indirect_amdx)(command_buffer, scratch, scratch_size, count_info)
    }
    ...
    pub unsafe fn cmd_dispatch_graph_indirect_count(
        ...
        (self.fp.cmd_dispatch_graph_indirect_count_amdx)(command_buffer, scratch, scratch_size, count_info)
    }
}
