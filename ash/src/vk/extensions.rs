            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                ...
                queue_present_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkQueuePresentKHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        queue_present_khr
                    } else {
...
pub mod khr_device_group {
    ...
    pub struct InstanceFn {
        pub get_physical_device_present_rectangles_khr:
            crate::vk::khr_swapchain::PFN_vkGetPhysicalDevicePresentRectanglesKHR,
    }
    unsafe impl Send for InstanceFn {}
    unsafe impl Sync for InstanceFn {}
    impl InstanceFn {
    ...
    pub struct DeviceFn {
        ...
        pub get_device_group_present_capabilities_khr:
            crate::vk::khr_swapchain::PFN_vkGetDeviceGroupPresentCapabilitiesKHR,
        pub get_device_group_surface_present_modes_khr:
            crate::vk::khr_swapchain::PFN_vkGetDeviceGroupSurfacePresentModesKHR,
        pub acquire_next_image2_khr: crate::vk::khr_swapchain::PFN_vkAcquireNextImage2KHR,
    }
    unsafe impl Send for DeviceFn {}
    unsafe impl Sync for DeviceFn {}
    impl DeviceFn {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                get_memory_fd_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkGetMemoryFdKHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        get_memory_fd_khr
                    } else {
...
pub mod khr_descriptor_update_template {
    ...
    pub struct DeviceFn {
        ...
        pub cmd_push_descriptor_set_with_template_khr:
            crate::vk::khr_push_descriptor::PFN_vkCmdPushDescriptorSetWithTemplateKHR,
    }
    unsafe impl Send for DeviceFn {}
    unsafe impl Sync for DeviceFn {}
    impl DeviceFn {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                ...
                get_fence_fd_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkGetFenceFdKHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        get_fence_fd_khr
                    } else {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                cmd_trace_rays_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkCmdTraceRaysKHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        cmd_trace_rays_khr
                    } else {
...
pub mod nv_ray_tracing {
    ...
    pub struct DeviceFn {
        ...
        pub get_ray_tracing_shader_group_handles_nv:
            crate::vk::khr_ray_tracing_pipeline::PFN_vkGetRayTracingShaderGroupHandlesKHR,
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                ...
                cmd_trace_rays_nv: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkCmdTraceRaysNV\0");
                    let val = _f(cname);
                    if val.is_null() {
                        cmd_trace_rays_nv
                    } else {
...
pub mod khr_draw_indirect_count {
    ...
    pub struct DeviceFn {
        pub cmd_draw_indirect_count_khr:
            crate::vk::amd_draw_indirect_count::PFN_vkCmdDrawIndirectCount,
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                map_memory2_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkMapMemory2KHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        map_memory2_khr
                    } else {
                ...
                unmap_memory2_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkUnmapMemory2KHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        unmap_memory2_khr
                    } else {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                cmd_set_event2_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkCmdSetEvent2KHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        cmd_set_event2_khr
                    } else {
                ...
                queue_submit2_khr: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkQueueSubmit2KHR\0");
                    let val = _f(cname);
                    if val.is_null() {
                        queue_submit2_khr
                    } else {
...
pub mod ext_image_compression_control {
    ...
    pub struct DeviceFn {
        pub get_image_subresource_layout2_ext:
            crate::vk::ext_host_image_copy::PFN_vkGetImageSubresourceLayout2KHR,
    }
    unsafe impl Send for DeviceFn {}
    unsafe impl Sync for DeviceFn {}
    impl DeviceFn {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                cmd_draw_multi_ext: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkCmdDrawMultiEXT\0");
                    let val = _f(cname);
                    if val.is_null() {
                        cmd_draw_multi_ext
                    } else {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                ...
                copy_micromap_ext: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkCopyMicromapEXT\0");
                    let val = _f(cname);
                    if val.is_null() {
                        copy_micromap_ext
                    } else {
...
pub mod khr_maintenance5 {
    ...
    pub struct DeviceFn {
        ...
        pub get_image_subresource_layout2_khr:
            crate::vk::ext_host_image_copy::PFN_vkGetImageSubresourceLayout2KHR,
    }
    unsafe impl Send for DeviceFn {}
    unsafe impl Sync for DeviceFn {}
...
pub mod ext_shader_object {
    ...
    pub struct DeviceFn {
        ...
        pub cmd_set_cull_mode_ext: crate::vk::ext_extended_dynamic_state::PFN_vkCmdSetCullMode,
        pub cmd_set_front_face_ext: crate::vk::ext_extended_dynamic_state::PFN_vkCmdSetFrontFace,
        ...
        pub cmd_bind_vertex_buffers2_ext:
        ...
        pub cmd_set_depth_compare_op_ext:
            crate::vk::ext_extended_dynamic_state::PFN_vkCmdSetDepthCompareOp,
        ...
        pub cmd_set_stencil_op_ext: crate::vk::ext_extended_dynamic_state::PFN_vkCmdSetStencilOp,
        pub cmd_set_vertex_input_ext:
            crate::vk::ext_vertex_input_dynamic_state::PFN_vkCmdSetVertexInputEXT,
        pub cmd_set_patch_control_points_ext:
            crate::vk::ext_extended_dynamic_state2::PFN_vkCmdSetPatchControlPointsEXT,
        ...
        pub cmd_set_logic_op_ext: crate::vk::ext_extended_dynamic_state2::PFN_vkCmdSetLogicOpEXT,
        ...
        pub cmd_set_tessellation_domain_origin_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetTessellationDomainOriginEXT,
        pub cmd_set_depth_clamp_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetDepthClampEnableEXT,
        pub cmd_set_polygon_mode_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetPolygonModeEXT,
        pub cmd_set_rasterization_samples_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetRasterizationSamplesEXT,
        pub cmd_set_sample_mask_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetSampleMaskEXT,
        pub cmd_set_alpha_to_coverage_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetAlphaToCoverageEnableEXT,
        pub cmd_set_alpha_to_one_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetAlphaToOneEnableEXT,
        pub cmd_set_logic_op_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetLogicOpEnableEXT,
        pub cmd_set_color_blend_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetColorBlendEnableEXT,
        pub cmd_set_color_blend_equation_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetColorBlendEquationEXT,
        pub cmd_set_color_write_mask_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetColorWriteMaskEXT,
        pub cmd_set_rasterization_stream_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetRasterizationStreamEXT,
        pub cmd_set_conservative_rasterization_mode_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetConservativeRasterizationModeEXT,
        pub cmd_set_extra_primitive_overestimation_size_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetExtraPrimitiveOverestimationSizeEXT,
        pub cmd_set_depth_clip_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetDepthClipEnableEXT,
        pub cmd_set_sample_locations_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetSampleLocationsEnableEXT,
        pub cmd_set_color_blend_advanced_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetColorBlendAdvancedEXT,
        pub cmd_set_provoking_vertex_mode_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetProvokingVertexModeEXT,
        pub cmd_set_line_rasterization_mode_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetLineRasterizationModeEXT,
        pub cmd_set_line_stipple_enable_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetLineStippleEnableEXT,
        pub cmd_set_depth_clip_negative_one_to_one_ext:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetDepthClipNegativeOneToOneEXT,
        pub cmd_set_viewport_w_scaling_enable_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetViewportWScalingEnableNV,
        pub cmd_set_viewport_swizzle_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetViewportSwizzleNV,
        pub cmd_set_coverage_to_color_enable_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetCoverageToColorEnableNV,
        pub cmd_set_coverage_to_color_location_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetCoverageToColorLocationNV,
        pub cmd_set_coverage_modulation_mode_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetCoverageModulationModeNV,
        pub cmd_set_coverage_modulation_table_enable_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetCoverageModulationTableEnableNV,
        pub cmd_set_coverage_modulation_table_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetCoverageModulationTableNV,
        pub cmd_set_shading_rate_image_enable_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetShadingRateImageEnableNV,
        pub cmd_set_representative_fragment_test_enable_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetRepresentativeFragmentTestEnableNV,
        pub cmd_set_coverage_reduction_mode_nv:
            crate::vk::ext_extended_dynamic_state3::PFN_vkCmdSetCoverageReductionModeNV,
    }
    unsafe impl Send for DeviceFn {}
    unsafe impl Sync for DeviceFn {}
    impl DeviceFn {
            ...
            F: FnMut(&::std::ffi::CStr) -> *const c_void,
        {
            Self {
                ...
                latency_sleep_nv: unsafe {
                    ...
                    let cname =
                        ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"vkLatencySleepNV\0");
                    let val = _f(cname);
                    if val.is_null() {
                        latency_sleep_nv
                    } else {
