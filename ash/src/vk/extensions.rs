...
impl StructureType {
    ...
    pub const PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID: Self = Self(
        1_000_010_002,
    );
}
...
impl AccessFlags2 {
    pub const VIDEO_DECODE_READ_KHR: Self = Self(
        0b1000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
...
impl AccessFlags {
    ...
    pub const TRANSFORM_FEEDBACK_COUNTER_READ_EXT: Self = Self(
        0b100_0000_0000_0000_0000_0000_0000,
    );
...
impl StructureType {
    ...
    pub const VIDEO_ENCODE_H264_SESSION_PARAMETERS_ADD_INFO_KHR: Self = Self(
        1_000_038_002,
    );
    ...
    pub const VIDEO_ENCODE_H264_SESSION_PARAMETERS_GET_INFO_KHR: Self = Self(
        1_000_038_012,
    );
...
impl StructureType {
    ...
    pub const VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_KHR: Self = Self(
        1_000_039_002,
    );
    ...
    pub const VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO_KHR: Self = Self(
        1_000_039_013,
    );
...
///Generated from 'VK_KHR_shader_bfloat16'
impl ComponentTypeKHR {
    pub const BFLOAT16: Self = Self(1_000_141_000);
}
///Generated from 'VK_KHR_shader_bfloat16'
impl StructureType {
    pub const PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR: Self = Self(1_000_141_000);
}
...
impl StructureType {
    ...
    pub const PHYSICAL_DEVICE_SHADER_SM_BUILTINS_PROPERTIES_NV: Self = Self(
        1_000_154_001,
    );
}
...
impl AccessFlags {
    pub const FRAGMENT_DENSITY_MAP_READ_EXT: Self = Self(
        0b1_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_EXT_fragment_density_map'
impl FormatFeatureFlags {
...
impl StructureType {
    pub const PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT: Self = Self(
        1_000_260_000,
    );
}
...
impl StructureType {
    ...
    pub const PHYSICAL_DEVICE_MAP_MEMORY_PLACED_PROPERTIES_EXT: Self = Self(
        1_000_272_001,
    );
...
impl StructureType {
    ...
    pub const PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT: Self = Self(
        1_000_287_002,
    );
}
...
impl AccessFlags2 {
    pub const VIDEO_ENCODE_READ_KHR: Self = Self(
        0b10_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
...
///Generated from 'VK_QCOM_tile_shading'
impl AccessFlags2 {
    pub const SHADER_TILE_ATTACHMENT_READ_QCOM: Self = Self(
        0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
...
///Generated from 'VK_QCOM_tile_shading'
impl StructureType {
    pub const PHYSICAL_DEVICE_TILE_SHADING_FEATURES_QCOM: Self = Self(1_000_309_000);
    pub const PHYSICAL_DEVICE_TILE_SHADING_PROPERTIES_QCOM: Self = Self(1_000_309_001);
    pub const RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM: Self = Self(1_000_309_002);
    pub const PER_TILE_BEGIN_INFO_QCOM: Self = Self(1_000_309_003);
    pub const PER_TILE_END_INFO_QCOM: Self = Self(1_000_309_004);
    pub const DISPATCH_TILE_INFO_QCOM: Self = Self(1_000_309_005);
}
///Generated from 'VK_QCOM_tile_shading'
impl SubpassDescriptionFlags {
    pub const TILE_SHADING_APRON_QCOM: Self = Self(0b1_0000_0000);
}
...
impl AccessFlags2 {
    pub const DESCRIPTOR_BUFFER_READ_EXT: Self = Self(
        0b10_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_EXT_descriptor_buffer'
impl BufferCreateFlags {
...
impl PipelineStageFlags2 {
    pub const SUBPASS_SHADER_HUAWEI: Self = Self(
        0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_HUAWEI_subpass_shading'
impl ShaderStageFlags {
...
impl AccessFlags2 {
    pub const MICROMAP_READ_EXT: Self = Self(
        0b1_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
    pub const MICROMAP_WRITE_EXT: Self = Self(
        0b10_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_EXT_opacity_micromap'
impl BufferUsageFlags {
...
impl StructureType {
    ...
    pub const PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_NV: Self = Self(
        1_000_426_001,
    );
}
///Generated from 'VK_NV_memory_decompression'
impl StructureType {
    pub const PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_FEATURES_NV: Self = Self(
        1_000_427_000,
    );
    pub const PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_PROPERTIES_NV: Self = Self(
        1_000_427_001,
    );
}
...
impl FormatFeatureFlags2 {
    pub const WEIGHT_IMAGE_QCOM: Self = Self(
        0b100_0000_0000_0000_0000_0000_0000_0000_0000,
    );
...
impl DescriptorType {
    pub const TENSOR_ARM: Self = Self(1_000_460_000);
}
///Generated from 'VK_ARM_tensors'
impl Format {
...
impl FormatFeatureFlags2 {
    ...
    pub const TENSOR_IMAGE_ALIASING_ARM: Self = Self(
        0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_ARM_tensors'
impl ImageLayout {
    pub const TENSOR_ALIASING_ARM: Self = Self(1_000_460_000);
}
///Generated from 'VK_ARM_tensors'
impl ImageUsageFlags {
...
impl ObjectType {
    pub const TENSOR_ARM: Self = Self(1_000_460_000);
    pub const TENSOR_VIEW_ARM: Self = Self(1_000_460_001);
}
///Generated from 'VK_ARM_tensors'
impl StructureType {
    pub const TENSOR_CREATE_INFO_ARM: Self = Self(1_000_460_000);
    pub const TENSOR_VIEW_CREATE_INFO_ARM: Self = Self(1_000_460_001);
    pub const BIND_TENSOR_MEMORY_INFO_ARM: Self = Self(1_000_460_002);
    pub const WRITE_DESCRIPTOR_SET_TENSOR_ARM: Self = Self(1_000_460_003);
    pub const PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM: Self = Self(1_000_460_004);
    pub const TENSOR_FORMAT_PROPERTIES_ARM: Self = Self(1_000_460_005);
    pub const TENSOR_DESCRIPTION_ARM: Self = Self(1_000_460_006);
    pub const TENSOR_MEMORY_REQUIREMENTS_INFO_ARM: Self = Self(1_000_460_007);
    pub const TENSOR_MEMORY_BARRIER_ARM: Self = Self(1_000_460_008);
    pub const PHYSICAL_DEVICE_TENSOR_FEATURES_ARM: Self = Self(1_000_460_009);
    pub const DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM: Self = Self(1_000_460_010);
    pub const COPY_TENSOR_INFO_ARM: Self = Self(1_000_460_011);
    pub const TENSOR_COPY_ARM: Self = Self(1_000_460_012);
    pub const TENSOR_DEPENDENCY_INFO_ARM: Self = Self(1_000_460_013);
    pub const MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM: Self = Self(1_000_460_014);
    pub const PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM: Self = Self(1_000_460_015);
    pub const EXTERNAL_TENSOR_PROPERTIES_ARM: Self = Self(1_000_460_016);
    pub const EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM: Self = Self(1_000_460_017);
    ...
    pub const DESCRIPTOR_GET_TENSOR_INFO_ARM: Self = Self(1_000_460_020);
    pub const TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM: Self = Self(1_000_460_021);
    pub const TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM: Self = Self(1_000_460_022);
    pub const FRAME_BOUNDARY_TENSORS_ARM: Self = Self(1_000_460_023);
}
///Generated from 'VK_ARM_tensors'
impl TensorCreateFlagsARM {
    pub const DESCRIPTOR_BUFFER_CAPTURE_REPLAY: Self = Self(0b100);
}
///Generated from 'VK_ARM_tensors'
impl TensorViewCreateFlagsARM {
    pub const DESCRIPTOR_BUFFER_CAPTURE_REPLAY: Self = Self(0b1);
}
...
impl AccessFlags2 {
    pub const OPTICAL_FLOW_READ_NV: Self = Self(
        0b100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
...
///Generated from 'VK_KHR_present_id2'
impl StructureType {
    pub const SURFACE_CAPABILITIES_PRESENT_ID_2_KHR: Self = Self(1_000_479_000);
    pub const PRESENT_ID_2_KHR: Self = Self(1_000_479_001);
    pub const PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR: Self = Self(1_000_479_002);
}
///Generated from 'VK_KHR_present_id2'
impl SwapchainCreateFlagsKHR {
    ///Allow use of VK_KHR_present_id2 with this swapchain
    pub const PRESENT_ID_2: Self = Self(0b100_0000);
}
///Generated from 'VK_KHR_present_wait2'
impl StructureType {
    pub const SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR: Self = Self(1_000_480_000);
    pub const PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR: Self = Self(1_000_480_001);
    pub const PRESENT_WAIT_2_INFO_KHR: Self = Self(1_000_480_002);
}
///Generated from 'VK_KHR_present_wait2'
impl SwapchainCreateFlagsKHR {
    ///Allow use of VK_KHR_present_wait2 with this swapchain
    pub const PRESENT_WAIT_2: Self = Self(0b1000_0000);
}
...
///Generated from 'VK_KHR_surface_maintenance1'
impl StructureType {
    pub const SURFACE_PRESENT_MODE_KHR: Self = Self(1_000_274_000);
    pub const SURFACE_PRESENT_SCALING_CAPABILITIES_KHR: Self = Self(1_000_274_001);
    pub const SURFACE_PRESENT_MODE_COMPATIBILITY_KHR: Self = Self(1_000_274_002);
}
///Generated from 'VK_KHR_swapchain_maintenance1'
impl StructureType {
    pub const PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR: Self = Self(
        1_000_275_000,
    );
    pub const SWAPCHAIN_PRESENT_FENCE_INFO_KHR: Self = Self(1_000_275_001);
    pub const SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR: Self = Self(1_000_275_002);
    pub const SWAPCHAIN_PRESENT_MODE_INFO_KHR: Self = Self(1_000_275_003);
    pub const SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR: Self = Self(1_000_275_004);
    pub const RELEASE_SWAPCHAIN_IMAGES_INFO_KHR: Self = Self(1_000_275_005);
}
///Generated from 'VK_KHR_swapchain_maintenance1'
impl SwapchainCreateFlagsKHR {
    pub const DEFERRED_MEMORY_ALLOCATION: Self = Self(0b1000);
}
...
///Generated from 'VK_NV_cooperative_vector'
impl ComponentTypeKHR {
...
impl AccessFlags2 {
    pub const DATA_GRAPH_READ_ARM: Self = Self(
        0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
    pub const DATA_GRAPH_WRITE_ARM: Self = Self(
        0b1_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_ARM_data_graph'
impl BufferUsageFlags2 {
...
///Generated from 'VK_ARM_data_graph'
impl ObjectType {
    pub const DATA_GRAPH_PIPELINE_SESSION_ARM: Self = Self(1_000_507_000);
}
///Generated from 'VK_ARM_data_graph'
impl PipelineBindPoint {
    pub const DATA_GRAPH_ARM: Self = Self(1_000_507_000);
}
///Generated from 'VK_ARM_data_graph'
impl PipelineStageFlags2 {
...
///Generated from 'VK_ARM_data_graph'
impl QueueFlags {
    pub const DATA_GRAPH_ARM: Self = Self(0b100_0000_0000);
}
///Generated from 'VK_ARM_data_graph'
impl StructureType {
    pub const DATA_GRAPH_PIPELINE_CREATE_INFO_ARM: Self = Self(1_000_507_000);
    pub const DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM: Self = Self(1_000_507_001);
    pub const DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM: Self = Self(1_000_507_002);
    pub const DATA_GRAPH_PIPELINE_CONSTANT_ARM: Self = Self(1_000_507_003);
    ...
    pub const PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM: Self = Self(1_000_507_006);
    pub const DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM: Self = Self(
        1_000_507_007,
    );
    pub const DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM: Self = Self(1_000_507_008);
    pub const DATA_GRAPH_PIPELINE_INFO_ARM: Self = Self(1_000_507_009);
    ...
    pub const DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM: Self = Self(1_000_507_013);
    pub const DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM: Self = Self(1_000_507_014);
    pub const DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM: Self = Self(1_000_507_016);
    pub const QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM: Self = Self(
        1_000_507_017,
    );
    pub const QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM: Self = Self(1_000_507_018);
...
///Generated from 'VK_KHR_video_decode_vp9'
impl StructureType {
    pub const PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR: Self = Self(1_000_514_000);
    pub const VIDEO_DECODE_VP9_CAPABILITIES_KHR: Self = Self(1_000_514_001);
    pub const VIDEO_DECODE_VP9_PICTURE_INFO_KHR: Self = Self(1_000_514_002);
    pub const VIDEO_DECODE_VP9_PROFILE_INFO_KHR: Self = Self(1_000_514_003);
}
///Generated from 'VK_KHR_video_decode_vp9'
impl VideoCodecOperationFlagsKHR {
    pub const DECODE_VP9: Self = Self(0b1000);
}
...
///Generated from 'VK_KHR_unified_image_layouts'
impl StructureType {
    pub const PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR: Self = Self(
        1_000_527_000,
    );
    pub const ATTACHMENT_FEEDBACK_LOOP_INFO_EXT: Self = Self(1_000_527_001);
}
...
///Generated from 'VK_QCOM_tile_memory_heap'
impl MemoryHeapFlags {
    pub const TILE_MEMORY_QCOM: Self = Self(0b1000);
}
///Generated from 'VK_QCOM_tile_memory_heap'
impl StructureType {
    pub const PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM: Self = Self(1_000_547_000);
    pub const PHYSICAL_DEVICE_TILE_MEMORY_HEAP_PROPERTIES_QCOM: Self = Self(
        1_000_547_001,
    );
    pub const TILE_MEMORY_REQUIREMENTS_QCOM: Self = Self(1_000_547_002);
    pub const TILE_MEMORY_BIND_INFO_QCOM: Self = Self(1_000_547_003);
    pub const TILE_MEMORY_SIZE_INFO_QCOM: Self = Self(1_000_547_004);
}
...
///Generated from 'VK_KHR_video_encode_intra_refresh'
impl StructureType {
    pub const VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR: Self = Self(1_000_552_000);
    pub const VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR: Self = Self(
        1_000_552_001,
    );
    pub const VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR: Self = Self(1_000_552_002);
    pub const VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR: Self = Self(1_000_552_003);
...
impl VideoEncodeAV1CapabilityFlagsKHR {
    pub const COMPOUND_PREDICTION_INTRA_REFRESH: Self = Self(0b10_0000);
}
///Generated from 'VK_KHR_video_encode_intra_refresh'
impl VideoEncodeFlagsKHR {
    pub const INTRA_REFRESH: Self = Self(0b100);
}
///Generated from 'VK_KHR_video_encode_intra_refresh'
impl VideoEncodeH264CapabilityFlagsKHR {
    pub const B_PICTURE_INTRA_REFRESH: Self = Self(0b100_0000_0000);
}
///Generated from 'VK_KHR_video_encode_intra_refresh'
impl VideoEncodeH265CapabilityFlagsKHR {
    pub const B_PICTURE_INTRA_REFRESH: Self = Self(0b1000_0000_0000);
}
///Generated from 'VK_KHR_video_encode_quantization_map'
impl FormatFeatureFlags2 {
    pub const VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_KHR: Self = Self(
        0b10_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
    pub const VIDEO_ENCODE_EMPHASIS_MAP_KHR: Self = Self(
        0b100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000,
    );
}
///Generated from 'VK_KHR_video_encode_quantization_map'
impl ImageLayout {
...
impl StructureType {
    ...
    pub const VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR: Self = Self(
        1_000_553_006,
    );
    pub const VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR: Self = Self(
        1_000_553_007,
    );
    pub const VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR: Self = Self(
        1_000_553_008,
    );
}
///Generated from 'VK_KHR_video_encode_quantization_map'
...
///Generated from 'VK_NV_external_compute_queue'
impl ObjectType {
    pub const EXTERNAL_COMPUTE_QUEUE_NV: Self = Self(1_000_556_000);
}
///Generated from 'VK_NV_external_compute_queue'
impl StructureType {
    pub const EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV: Self = Self(1_000_556_000);
    pub const EXTERNAL_COMPUTE_QUEUE_CREATE_INFO_NV: Self = Self(1_000_556_001);
    pub const EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV: Self = Self(1_000_556_002);
...
///Generated from 'VK_EXT_shader_float8'
impl ComponentTypeKHR {
    pub const FLOAT8_E4M3_EXT: Self = Self(1_000_491_002);
    pub const FLOAT8_E5M2_EXT: Self = Self(1_000_491_003);
}
///Generated from 'VK_EXT_shader_float8'
impl StructureType {
    pub const PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT: Self = Self(1_000_567_000);
}
...
///Generated from 'VK_NV_cluster_acceleration_structure'
...
///Generated from 'VK_NV_partitioned_acceleration_structure'
impl DescriptorType {
...
///Generated from 'VK_KHR_maintenance8'
impl DependencyFlags {
...
///Generated from 'VK_KHR_maintenance9'
impl DependencyFlags {
    pub const ASYMMETRIC_EVENT_KHR: Self = Self(0b100_0000);
}
///Generated from 'VK_KHR_maintenance9'
impl QueryPoolCreateFlags {
    pub const RESET_KHR: Self = Self(0b1);
}
///Generated from 'VK_KHR_maintenance9'
impl StructureType {
    pub const PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR: Self = Self(1_000_584_000);
    pub const PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR: Self = Self(1_000_584_001);
    pub const QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR: Self = Self(1_000_584_002);
}
///Generated from 'VK_KHR_video_maintenance2'
impl StructureType {
...
impl StructureType {
    pub const OH_SURFACE_CREATE_INFO_OHOS: Self = Self(1_000_587_000);
}
...
///Generated from 'VK_ARM_pipeline_opacity_micromap'
impl StructureType {
    pub const PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM: Self = Self(
        1_000_596_000,
    );
}
///Generated from 'VK_EXT_external_memory_metal'
impl ExternalMemoryHandleTypeFlags {
...
///Generated from 'VK_KHR_depth_clamp_zero_one'
impl StructureType {
...
///Generated from 'VK_ARM_format_pack'
impl Format {
    pub const R10X6_UINT_PACK16_ARM: Self = Self(1_000_609_000);
    pub const R10X6G10X6_UINT_2PACK16_ARM: Self = Self(1_000_609_001);
    pub const R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM: Self = Self(1_000_609_002);
    pub const R12X4_UINT_PACK16_ARM: Self = Self(1_000_609_003);
    pub const R12X4G12X4_UINT_2PACK16_ARM: Self = Self(1_000_609_004);
    pub const R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM: Self = Self(1_000_609_005);
    pub const R14X2_UINT_PACK16_ARM: Self = Self(1_000_609_006);
    pub const R14X2G14X2_UINT_2PACK16_ARM: Self = Self(1_000_609_007);
    pub const R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM: Self = Self(1_000_609_008);
    pub const R14X2_UNORM_PACK16_ARM: Self = Self(1_000_609_009);
    pub const R14X2G14X2_UNORM_2PACK16_ARM: Self = Self(1_000_609_010);
    pub const R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM: Self = Self(1_000_609_011);
    pub const G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM: Self = Self(1_000_609_012);
    pub const G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM: Self = Self(1_000_609_013);
}
///Generated from 'VK_ARM_format_pack'
impl StructureType {
    pub const PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM: Self = Self(1_000_609_000);
}
...
///Generated from 'VK_VALVE_fragment_density_map_layered'
impl RenderPassCreateFlags {
    pub const PER_LAYER_FRAGMENT_DENSITY_VALVE: Self = Self(0b100);
}
///Generated from 'VK_VALVE_fragment_density_map_layered'
impl RenderingFlags {
    pub const PER_LAYER_FRAGMENT_DENSITY_VALVE: Self = Self(0b10_0000);
}
///Generated from 'VK_VALVE_fragment_density_map_layered'
impl StructureType {
...
///Generated from 'VK_KHR_robustness2'
impl StructureType {
    pub const PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR: Self = Self(1_000_286_000);
    pub const PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR: Self = Self(1_000_286_001);
}
///Generated from 'VK_NV_present_metering'
impl StructureType {
...
///Generated from 'VK_EXT_fragment_density_map_offset'
impl ImageCreateFlags {
...
///Generated from 'VK_EXT_zero_initialize_device_memory'
impl ImageLayout {
    pub const ZERO_INITIALIZED_EXT: Self = Self(1_000_620_000);
}
///Generated from 'VK_EXT_zero_initialize_device_memory'
impl MemoryAllocateFlags {
    pub const ZERO_INITIALIZE_EXT: Self = Self(0b1000);
}
///Generated from 'VK_EXT_zero_initialize_device_memory'
impl StructureType {
...
///Generated from 'VK_KHR_present_mode_fifo_latest_ready'
impl PresentModeKHR {
    pub const FIFO_LATEST_READY: Self = Self(1_000_361_000);
}
///Generated from 'VK_KHR_present_mode_fifo_latest_ready'
impl StructureType {
...
pub const KHR_SWAPCHAIN_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_swapchain\0")
};
...
pub const KHR_DISPLAY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_display\0")
};
...
pub const KHR_DISPLAY_SWAPCHAIN_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_display_swapchain\0")
};
...
pub const KHR_XLIB_SURFACE_NAME: &CStr = unsafe {
...
pub const KHR_XCB_SURFACE_NAME: &CStr = unsafe {
...
pub const KHR_WAYLAND_SURFACE_NAME: &CStr = unsafe {
...
pub const KHR_ANDROID_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_android_surface\0")
};
...
pub const KHR_WIN32_SURFACE_NAME: &CStr = unsafe {
...
pub const ANDROID_NATIVE_BUFFER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ANDROID_native_buffer\0")
};
...
pub const EXT_DEBUG_REPORT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_debug_report\0")
};
...
pub const NV_GLSL_SHADER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_glsl_shader\0")
};
pub const NV_GLSL_SHADER_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEPTH_RANGE_UNRESTRICTED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_depth_range_unrestricted\0")
};
pub const EXT_DEPTH_RANGE_UNRESTRICTED_SPEC_VERSION: u32 = 1u32;
pub const KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_sampler_mirror_clamp_to_edge\0")
};
pub const KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_SPEC_VERSION: u32 = 3u32;
pub const IMG_FILTER_CUBIC_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_IMG_filter_cubic\0")
};
pub const IMG_FILTER_CUBIC_SPEC_VERSION: u32 = 1u32;
pub const AMD_RASTERIZATION_ORDER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_rasterization_order\0")
};
pub const AMD_RASTERIZATION_ORDER_SPEC_VERSION: u32 = 1u32;
pub const AMD_SHADER_TRINARY_MINMAX_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_trinary_minmax\0")
};
pub const AMD_SHADER_TRINARY_MINMAX_SPEC_VERSION: u32 = 1u32;
pub const AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_explicit_vertex_parameter\0")
};
pub const AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEBUG_MARKER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_debug_marker\0")
};
...
pub const KHR_VIDEO_QUEUE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_queue\0")
};
...
pub const KHR_VIDEO_DECODE_QUEUE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_decode_queue\0")
};
...
pub const AMD_GCN_SHADER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_gcn_shader\0")
};
pub const AMD_GCN_SHADER_SPEC_VERSION: u32 = 1u32;
pub const NV_DEDICATED_ALLOCATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_dedicated_allocation\0")
};
pub const NV_DEDICATED_ALLOCATION_SPEC_VERSION: u32 = 1u32;
pub const EXT_TRANSFORM_FEEDBACK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_transform_feedback\0")
};
...
pub const NVX_BINARY_IMPORT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NVX_binary_import\0")
};
...
pub const AMD_NEGATIVE_VIEWPORT_HEIGHT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_negative_viewport_height\0")
};
pub const AMD_NEGATIVE_VIEWPORT_HEIGHT_SPEC_VERSION: u32 = 1u32;
pub const AMD_GPU_SHADER_HALF_FLOAT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_gpu_shader_half_float\0")
};
pub const AMD_GPU_SHADER_HALF_FLOAT_SPEC_VERSION: u32 = 2u32;
pub const AMD_SHADER_BALLOT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_ballot\0")
};
pub const AMD_SHADER_BALLOT_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_ENCODE_H264_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_encode_h264\0")
};
pub const KHR_VIDEO_ENCODE_H264_SPEC_VERSION: u32 = 14u32;
pub const KHR_VIDEO_ENCODE_H265_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_encode_h265\0")
};
pub const KHR_VIDEO_ENCODE_H265_SPEC_VERSION: u32 = 14u32;
pub const KHR_VIDEO_DECODE_H264_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_decode_h264\0")
};
pub const KHR_VIDEO_DECODE_H264_SPEC_VERSION: u32 = 9u32;
pub const AMD_TEXTURE_GATHER_BIAS_LOD_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_texture_gather_bias_lod\0")
};
pub const AMD_TEXTURE_GATHER_BIAS_LOD_SPEC_VERSION: u32 = 1u32;
pub const AMD_SHADER_INFO_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_info\0")
};
...
pub const KHR_DYNAMIC_RENDERING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_dynamic_rendering\0")
};
...
pub const AMD_SHADER_IMAGE_LOAD_STORE_LOD_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_image_load_store_lod\0")
};
pub const AMD_SHADER_IMAGE_LOAD_STORE_LOD_SPEC_VERSION: u32 = 1u32;
pub const GGP_STREAM_DESCRIPTOR_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_GGP_stream_descriptor_surface\0")
};
...
pub const NV_CORNER_SAMPLED_IMAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_corner_sampled_image\0")
};
pub const NV_CORNER_SAMPLED_IMAGE_SPEC_VERSION: u32 = 2u32;
pub const KHR_MULTIVIEW_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_multiview\0")
};
pub const KHR_MULTIVIEW_SPEC_VERSION: u32 = 1u32;
pub const IMG_FORMAT_PVRTC_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_IMG_format_pvrtc\0")
};
pub const IMG_FORMAT_PVRTC_SPEC_VERSION: u32 = 1u32;
pub const NV_EXTERNAL_MEMORY_CAPABILITIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_external_memory_capabilities\0")
};
...
pub const NV_EXTERNAL_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_external_memory\0")
};
pub const NV_EXTERNAL_MEMORY_SPEC_VERSION: u32 = 1u32;
pub const NV_EXTERNAL_MEMORY_WIN32_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_external_memory_win32\0")
};
...
pub const NV_WIN32_KEYED_MUTEX_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_win32_keyed_mutex\0")
};
pub const NV_WIN32_KEYED_MUTEX_SPEC_VERSION: u32 = 2u32;
pub const KHR_GET_PHYSICAL_DEVICE_PROPERTIES2_NAME: &CStr = unsafe {
...
pub const KHR_DEVICE_GROUP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_device_group\0")
};
...
pub const EXT_VALIDATION_FLAGS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_validation_flags\0")
};
pub const EXT_VALIDATION_FLAGS_SPEC_VERSION: u32 = 3u32;
pub const NN_VI_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NN_vi_surface\0")
};
...
pub const KHR_SHADER_DRAW_PARAMETERS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_draw_parameters\0")
};
pub const KHR_SHADER_DRAW_PARAMETERS_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_SUBGROUP_BALLOT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_subgroup_ballot\0")
};
pub const EXT_SHADER_SUBGROUP_BALLOT_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_SUBGROUP_VOTE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_subgroup_vote\0")
};
pub const EXT_SHADER_SUBGROUP_VOTE_SPEC_VERSION: u32 = 1u32;
pub const EXT_TEXTURE_COMPRESSION_ASTC_HDR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_texture_compression_astc_hdr\0")
};
pub const EXT_TEXTURE_COMPRESSION_ASTC_HDR_SPEC_VERSION: u32 = 1u32;
pub const EXT_ASTC_DECODE_MODE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_astc_decode_mode\0")
};
pub const EXT_ASTC_DECODE_MODE_SPEC_VERSION: u32 = 1u32;
pub const EXT_PIPELINE_ROBUSTNESS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pipeline_robustness\0")
};
pub const EXT_PIPELINE_ROBUSTNESS_SPEC_VERSION: u32 = 1u32;
pub const KHR_MAINTENANCE1_NAME: &CStr = unsafe {
...
pub const KHR_DEVICE_GROUP_CREATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_device_group_creation\0")
};
...
pub const KHR_EXTERNAL_MEMORY_CAPABILITIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_memory_capabilities\0")
};
...
pub const KHR_EXTERNAL_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_memory\0")
};
pub const KHR_EXTERNAL_MEMORY_SPEC_VERSION: u32 = 1u32;
pub const KHR_EXTERNAL_MEMORY_WIN32_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_memory_win32\0")
};
...
pub const KHR_EXTERNAL_MEMORY_FD_NAME: &CStr = unsafe {
...
pub const KHR_WIN32_KEYED_MUTEX_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_win32_keyed_mutex\0")
};
pub const KHR_WIN32_KEYED_MUTEX_SPEC_VERSION: u32 = 1u32;
pub const KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_semaphore_capabilities\0")
};
...
pub const KHR_EXTERNAL_SEMAPHORE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_semaphore\0")
};
pub const KHR_EXTERNAL_SEMAPHORE_SPEC_VERSION: u32 = 1u32;
pub const KHR_EXTERNAL_SEMAPHORE_WIN32_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_semaphore_win32\0")
};
...
pub const KHR_EXTERNAL_SEMAPHORE_FD_NAME: &CStr = unsafe {
...
pub const KHR_PUSH_DESCRIPTOR_NAME: &CStr = unsafe {
...
pub const EXT_CONDITIONAL_RENDERING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_conditional_rendering\0")
};
...
pub const KHR_SHADER_FLOAT16_INT8_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_float16_int8\0")
};
pub const KHR_SHADER_FLOAT16_INT8_SPEC_VERSION: u32 = 1u32;
pub const KHR_16BIT_STORAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_16bit_storage\0")
};
pub const KHR_16BIT_STORAGE_SPEC_VERSION: u32 = 1u32;
pub const KHR_INCREMENTAL_PRESENT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_incremental_present\0")
};
pub const KHR_INCREMENTAL_PRESENT_SPEC_VERSION: u32 = 2u32;
pub const KHR_DESCRIPTOR_UPDATE_TEMPLATE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_descriptor_update_template\0")
};
...
pub const NV_CLIP_SPACE_W_SCALING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_clip_space_w_scaling\0")
};
...
pub const EXT_DIRECT_MODE_DISPLAY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_direct_mode_display\0")
};
...
pub const EXT_ACQUIRE_XLIB_DISPLAY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_acquire_xlib_display\0")
};
...
pub const EXT_DISPLAY_SURFACE_COUNTER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_display_surface_counter\0")
};
...
pub const EXT_DISPLAY_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_display_control\0")
};
...
pub const GOOGLE_DISPLAY_TIMING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_GOOGLE_display_timing\0")
};
...
pub const NV_SAMPLE_MASK_OVERRIDE_COVERAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_sample_mask_override_coverage\0")
};
pub const NV_SAMPLE_MASK_OVERRIDE_COVERAGE_SPEC_VERSION: u32 = 1u32;
pub const NV_GEOMETRY_SHADER_PASSTHROUGH_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_geometry_shader_passthrough\0")
};
pub const NV_GEOMETRY_SHADER_PASSTHROUGH_SPEC_VERSION: u32 = 1u32;
pub const NV_VIEWPORT_ARRAY2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_viewport_array2\0")
};
pub const NV_VIEWPORT_ARRAY2_SPEC_VERSION: u32 = 1u32;
pub const NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NVX_multiview_per_view_attributes\0")
};
pub const NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_SPEC_VERSION: u32 = 1u32;
pub const NV_VIEWPORT_SWIZZLE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_viewport_swizzle\0")
};
pub const NV_VIEWPORT_SWIZZLE_SPEC_VERSION: u32 = 1u32;
pub const EXT_DISCARD_RECTANGLES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_discard_rectangles\0")
};
...
pub const EXT_CONSERVATIVE_RASTERIZATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_conservative_rasterization\0")
};
pub const EXT_CONSERVATIVE_RASTERIZATION_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEPTH_CLIP_ENABLE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_depth_clip_enable\0")
};
pub const EXT_DEPTH_CLIP_ENABLE_SPEC_VERSION: u32 = 1u32;
pub const EXT_SWAPCHAIN_COLORSPACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_swapchain_colorspace\0")
};
pub const EXT_SWAPCHAIN_COLORSPACE_SPEC_VERSION: u32 = 5u32;
pub const EXT_HDR_METADATA_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_hdr_metadata\0")
};
...
pub const KHR_IMAGELESS_FRAMEBUFFER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_imageless_framebuffer\0")
};
pub const KHR_IMAGELESS_FRAMEBUFFER_SPEC_VERSION: u32 = 1u32;
pub const KHR_CREATE_RENDERPASS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_create_renderpass2\0")
};
...
pub const IMG_RELAXED_LINE_RASTERIZATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_IMG_relaxed_line_rasterization\0")
};
pub const IMG_RELAXED_LINE_RASTERIZATION_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHARED_PRESENTABLE_IMAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shared_presentable_image\0")
};
...
pub const KHR_EXTERNAL_FENCE_CAPABILITIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_fence_capabilities\0")
};
...
pub const KHR_EXTERNAL_FENCE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_fence\0")
};
pub const KHR_EXTERNAL_FENCE_SPEC_VERSION: u32 = 1u32;
pub const KHR_EXTERNAL_FENCE_WIN32_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_fence_win32\0")
};
...
pub const KHR_EXTERNAL_FENCE_FD_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_external_fence_fd\0")
};
...
pub const KHR_PERFORMANCE_QUERY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_performance_query\0")
};
...
pub const KHR_MAINTENANCE2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance2\0")
};
pub const KHR_MAINTENANCE2_SPEC_VERSION: u32 = 1u32;
pub const KHR_GET_SURFACE_CAPABILITIES2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_get_surface_capabilities2\0")
};
...
pub const KHR_VARIABLE_POINTERS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_variable_pointers\0")
};
pub const KHR_VARIABLE_POINTERS_SPEC_VERSION: u32 = 1u32;
pub const KHR_GET_DISPLAY_PROPERTIES2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_get_display_properties2\0")
};
...
pub const MVK_IOS_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_MVK_ios_surface\0")
};
...
pub const MVK_MACOS_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_MVK_macos_surface\0")
};
...
pub const EXT_EXTERNAL_MEMORY_DMA_BUF_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_external_memory_dma_buf\0")
};
pub const EXT_EXTERNAL_MEMORY_DMA_BUF_SPEC_VERSION: u32 = 1u32;
pub const EXT_QUEUE_FAMILY_FOREIGN_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_queue_family_foreign\0")
};
pub const EXT_QUEUE_FAMILY_FOREIGN_SPEC_VERSION: u32 = 1u32;
pub const KHR_DEDICATED_ALLOCATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_dedicated_allocation\0")
};
pub const KHR_DEDICATED_ALLOCATION_SPEC_VERSION: u32 = 3u32;
pub const EXT_DEBUG_UTILS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_debug_utils\0")
};
...
pub const EXT_SAMPLER_FILTER_MINMAX_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_sampler_filter_minmax\0")
};
pub const EXT_SAMPLER_FILTER_MINMAX_SPEC_VERSION: u32 = 2u32;
pub const KHR_STORAGE_BUFFER_STORAGE_CLASS_NAME: &CStr = unsafe {
...
pub const AMD_GPU_SHADER_INT16_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_gpu_shader_int16\0")
};
pub const AMD_GPU_SHADER_INT16_SPEC_VERSION: u32 = 2u32;
pub const AMDX_SHADER_ENQUEUE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMDX_shader_enqueue\0")
};
...
pub const AMD_SHADER_FRAGMENT_MASK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_fragment_mask\0")
};
pub const AMD_SHADER_FRAGMENT_MASK_SPEC_VERSION: u32 = 1u32;
pub const EXT_INLINE_UNIFORM_BLOCK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_inline_uniform_block\0")
};
pub const EXT_INLINE_UNIFORM_BLOCK_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_STENCIL_EXPORT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_stencil_export\0")
};
pub const EXT_SHADER_STENCIL_EXPORT_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_BFLOAT16_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_bfloat16\0")
};
pub const KHR_SHADER_BFLOAT16_SPEC_VERSION: u32 = 1u32;
pub const EXT_SAMPLE_LOCATIONS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_sample_locations\0")
};
...
pub const KHR_RELAXED_BLOCK_LAYOUT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_relaxed_block_layout\0")
};
pub const KHR_RELAXED_BLOCK_LAYOUT_SPEC_VERSION: u32 = 1u32;
pub const KHR_GET_MEMORY_REQUIREMENTS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_get_memory_requirements2\0")
};
...
pub const KHR_IMAGE_FORMAT_LIST_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_image_format_list\0")
};
pub const KHR_IMAGE_FORMAT_LIST_SPEC_VERSION: u32 = 1u32;
pub const EXT_BLEND_OPERATION_ADVANCED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_blend_operation_advanced\0")
};
pub const EXT_BLEND_OPERATION_ADVANCED_SPEC_VERSION: u32 = 2u32;
pub const NV_FRAGMENT_COVERAGE_TO_COLOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_fragment_coverage_to_color\0")
};
pub const NV_FRAGMENT_COVERAGE_TO_COLOR_SPEC_VERSION: u32 = 1u32;
pub const KHR_ACCELERATION_STRUCTURE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_acceleration_structure\0")
};
...
pub const KHR_RAY_TRACING_PIPELINE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_ray_tracing_pipeline\0")
};
...
pub const KHR_RAY_QUERY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_ray_query\0")
};
pub const KHR_RAY_QUERY_SPEC_VERSION: u32 = 1u32;
pub const NV_FRAMEBUFFER_MIXED_SAMPLES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_framebuffer_mixed_samples\0")
};
pub const NV_FRAMEBUFFER_MIXED_SAMPLES_SPEC_VERSION: u32 = 1u32;
pub const NV_FILL_RECTANGLE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_fill_rectangle\0")
};
pub const NV_FILL_RECTANGLE_SPEC_VERSION: u32 = 1u32;
pub const NV_SHADER_SM_BUILTINS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_shader_sm_builtins\0")
};
pub const NV_SHADER_SM_BUILTINS_SPEC_VERSION: u32 = 1u32;
pub const EXT_POST_DEPTH_COVERAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_post_depth_coverage\0")
};
pub const EXT_POST_DEPTH_COVERAGE_SPEC_VERSION: u32 = 1u32;
pub const KHR_SAMPLER_YCBCR_CONVERSION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_sampler_ycbcr_conversion\0")
};
...
pub const KHR_BIND_MEMORY2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_bind_memory2\0")
};
...
pub const EXT_IMAGE_DRM_FORMAT_MODIFIER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_drm_format_modifier\0")
};
...
pub const EXT_VALIDATION_CACHE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_validation_cache\0")
};
...
pub const EXT_DESCRIPTOR_INDEXING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_descriptor_indexing\0")
};
pub const EXT_DESCRIPTOR_INDEXING_SPEC_VERSION: u32 = 2u32;
pub const EXT_SHADER_VIEWPORT_INDEX_LAYER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_viewport_index_layer\0")
};
pub const EXT_SHADER_VIEWPORT_INDEX_LAYER_SPEC_VERSION: u32 = 1u32;
pub const KHR_PORTABILITY_SUBSET_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_portability_subset\0")
};
pub const KHR_PORTABILITY_SUBSET_SPEC_VERSION: u32 = 1u32;
pub const NV_SHADING_RATE_IMAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_shading_rate_image\0")
};
...
pub const NV_RAY_TRACING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_ray_tracing\0")
};
...
pub const NV_REPRESENTATIVE_FRAGMENT_TEST_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_representative_fragment_test\0")
};
pub const NV_REPRESENTATIVE_FRAGMENT_TEST_SPEC_VERSION: u32 = 2u32;
pub const KHR_MAINTENANCE3_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance3\0")
};
...
pub const KHR_DRAW_INDIRECT_COUNT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_draw_indirect_count\0")
};
pub const KHR_DRAW_INDIRECT_COUNT_SPEC_VERSION: u32 = 1u32;
pub const EXT_FILTER_CUBIC_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_filter_cubic\0")
};
pub const EXT_FILTER_CUBIC_SPEC_VERSION: u32 = 3u32;
pub const QCOM_RENDER_PASS_SHADER_RESOLVE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_render_pass_shader_resolve\0")
};
pub const QCOM_RENDER_PASS_SHADER_RESOLVE_SPEC_VERSION: u32 = 4u32;
pub const EXT_GLOBAL_PRIORITY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_global_priority\0")
};
pub const EXT_GLOBAL_PRIORITY_SPEC_VERSION: u32 = 2u32;
pub const KHR_SHADER_SUBGROUP_EXTENDED_TYPES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_subgroup_extended_types\0")
};
pub const KHR_SHADER_SUBGROUP_EXTENDED_TYPES_SPEC_VERSION: u32 = 1u32;
pub const KHR_8BIT_STORAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_8bit_storage\0")
};
pub const KHR_8BIT_STORAGE_SPEC_VERSION: u32 = 1u32;
pub const EXT_EXTERNAL_MEMORY_HOST_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_external_memory_host\0")
};
...
pub const AMD_BUFFER_MARKER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_buffer_marker\0")
};
...
pub const KHR_SHADER_ATOMIC_INT64_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_atomic_int64\0")
};
pub const KHR_SHADER_ATOMIC_INT64_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_CLOCK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_clock\0")
};
pub const KHR_SHADER_CLOCK_SPEC_VERSION: u32 = 1u32;
pub const AMD_PIPELINE_COMPILER_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_pipeline_compiler_control\0")
};
pub const AMD_PIPELINE_COMPILER_CONTROL_SPEC_VERSION: u32 = 1u32;
pub const EXT_CALIBRATED_TIMESTAMPS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_calibrated_timestamps\0")
};
...
pub const AMD_SHADER_CORE_PROPERTIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_core_properties\0")
};
pub const AMD_SHADER_CORE_PROPERTIES_SPEC_VERSION: u32 = 2u32;
pub const KHR_VIDEO_DECODE_H265_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_decode_h265\0")
};
pub const KHR_VIDEO_DECODE_H265_SPEC_VERSION: u32 = 8u32;
pub const KHR_GLOBAL_PRIORITY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_global_priority\0")
};
pub const KHR_GLOBAL_PRIORITY_SPEC_VERSION: u32 = 1u32;
pub const AMD_MEMORY_OVERALLOCATION_BEHAVIOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_memory_overallocation_behavior\0")
};
pub const AMD_MEMORY_OVERALLOCATION_BEHAVIOR_SPEC_VERSION: u32 = 1u32;
pub const EXT_VERTEX_ATTRIBUTE_DIVISOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_vertex_attribute_divisor\0")
};
pub const EXT_VERTEX_ATTRIBUTE_DIVISOR_SPEC_VERSION: u32 = 3u32;
pub const GGP_FRAME_TOKEN_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_GGP_frame_token\0")
};
pub const GGP_FRAME_TOKEN_SPEC_VERSION: u32 = 1u32;
pub const EXT_PIPELINE_CREATION_FEEDBACK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pipeline_creation_feedback\0")
};
pub const EXT_PIPELINE_CREATION_FEEDBACK_SPEC_VERSION: u32 = 1u32;
pub const KHR_DRIVER_PROPERTIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_driver_properties\0")
};
pub const KHR_DRIVER_PROPERTIES_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_FLOAT_CONTROLS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_float_controls\0")
};
pub const KHR_SHADER_FLOAT_CONTROLS_SPEC_VERSION: u32 = 4u32;
pub const NV_SHADER_SUBGROUP_PARTITIONED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_shader_subgroup_partitioned\0")
};
pub const NV_SHADER_SUBGROUP_PARTITIONED_SPEC_VERSION: u32 = 1u32;
pub const KHR_DEPTH_STENCIL_RESOLVE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_depth_stencil_resolve\0")
};
pub const KHR_DEPTH_STENCIL_RESOLVE_SPEC_VERSION: u32 = 1u32;
pub const KHR_SWAPCHAIN_MUTABLE_FORMAT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_swapchain_mutable_format\0")
};
pub const KHR_SWAPCHAIN_MUTABLE_FORMAT_SPEC_VERSION: u32 = 1u32;
pub const NV_COMPUTE_SHADER_DERIVATIVES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_compute_shader_derivatives\0")
};
pub const NV_COMPUTE_SHADER_DERIVATIVES_SPEC_VERSION: u32 = 1u32;
pub const NV_MESH_SHADER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_mesh_shader\0")
};
...
pub const NV_FRAGMENT_SHADER_BARYCENTRIC_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_fragment_shader_barycentric\0")
};
pub const NV_FRAGMENT_SHADER_BARYCENTRIC_SPEC_VERSION: u32 = 1u32;
pub const NV_SHADER_IMAGE_FOOTPRINT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_shader_image_footprint\0")
};
pub const NV_SHADER_IMAGE_FOOTPRINT_SPEC_VERSION: u32 = 2u32;
pub const NV_SCISSOR_EXCLUSIVE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_scissor_exclusive\0")
};
...
pub const NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_device_diagnostic_checkpoints\0")
};
...
pub const KHR_TIMELINE_SEMAPHORE_NAME: &CStr = unsafe {
...
pub const INTEL_SHADER_INTEGER_FUNCTIONS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_INTEL_shader_integer_functions2\0")
};
pub const INTEL_SHADER_INTEGER_FUNCTIONS2_SPEC_VERSION: u32 = 1u32;
pub const INTEL_PERFORMANCE_QUERY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_INTEL_performance_query\0")
};
...
pub const KHR_VULKAN_MEMORY_MODEL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_vulkan_memory_model\0")
};
pub const KHR_VULKAN_MEMORY_MODEL_SPEC_VERSION: u32 = 3u32;
pub const EXT_PCI_BUS_INFO_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pci_bus_info\0")
};
pub const EXT_PCI_BUS_INFO_SPEC_VERSION: u32 = 2u32;
pub const AMD_DISPLAY_NATIVE_HDR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_display_native_hdr\0")
};
...
pub const FUCHSIA_IMAGEPIPE_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_FUCHSIA_imagepipe_surface\0")
};
...
pub const KHR_SHADER_TERMINATE_INVOCATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_terminate_invocation\0")
};
pub const KHR_SHADER_TERMINATE_INVOCATION_SPEC_VERSION: u32 = 1u32;
pub const EXT_METAL_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_metal_surface\0")
};
...
pub const GOOGLE_HLSL_FUNCTIONALITY1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_GOOGLE_hlsl_functionality1\0")
};
pub const GOOGLE_HLSL_FUNCTIONALITY1_SPEC_VERSION: u32 = 1u32;
pub const GOOGLE_DECORATE_STRING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_GOOGLE_decorate_string\0")
};
pub const GOOGLE_DECORATE_STRING_SPEC_VERSION: u32 = 1u32;
pub const EXT_SUBGROUP_SIZE_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_subgroup_size_control\0")
};
pub const EXT_SUBGROUP_SIZE_CONTROL_SPEC_VERSION: u32 = 2u32;
pub const KHR_FRAGMENT_SHADING_RATE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_fragment_shading_rate\0")
};
...
pub const AMD_SHADER_CORE_PROPERTIES2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_shader_core_properties2\0")
};
pub const AMD_SHADER_CORE_PROPERTIES2_SPEC_VERSION: u32 = 1u32;
pub const AMD_DEVICE_COHERENT_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_device_coherent_memory\0")
};
pub const AMD_DEVICE_COHERENT_MEMORY_SPEC_VERSION: u32 = 1u32;
pub const KHR_DYNAMIC_RENDERING_LOCAL_READ_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_dynamic_rendering_local_read\0")
};
...
pub const EXT_SHADER_IMAGE_ATOMIC_INT64_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_image_atomic_int64\0")
};
pub const EXT_SHADER_IMAGE_ATOMIC_INT64_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_QUAD_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_quad_control\0")
};
pub const KHR_SHADER_QUAD_CONTROL_SPEC_VERSION: u32 = 1u32;
pub const KHR_SPIRV_1_4_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_spirv_1_4\0")
};
pub const KHR_SPIRV_1_4_SPEC_VERSION: u32 = 1u32;
pub const EXT_MEMORY_BUDGET_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_memory_budget\0")
};
pub const EXT_MEMORY_BUDGET_SPEC_VERSION: u32 = 1u32;
pub const EXT_MEMORY_PRIORITY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_memory_priority\0")
};
pub const EXT_MEMORY_PRIORITY_SPEC_VERSION: u32 = 1u32;
pub const KHR_SURFACE_PROTECTED_CAPABILITIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_surface_protected_capabilities\0")
};
pub const KHR_SURFACE_PROTECTED_CAPABILITIES_SPEC_VERSION: u32 = 1u32;
pub const NV_DEDICATED_ALLOCATION_IMAGE_ALIASING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_dedicated_allocation_image_aliasing\0")
};
pub const NV_DEDICATED_ALLOCATION_IMAGE_ALIASING_SPEC_VERSION: u32 = 1u32;
pub const KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_separate_depth_stencil_layouts\0")
};
pub const KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_SPEC_VERSION: u32 = 1u32;
pub const EXT_BUFFER_DEVICE_ADDRESS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_buffer_device_address\0")
};
...
pub const EXT_TOOLING_INFO_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_tooling_info\0")
};
...
pub const EXT_SEPARATE_STENCIL_USAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_separate_stencil_usage\0")
};
pub const EXT_SEPARATE_STENCIL_USAGE_SPEC_VERSION: u32 = 1u32;
pub const EXT_VALIDATION_FEATURES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_validation_features\0")
};
pub const EXT_VALIDATION_FEATURES_SPEC_VERSION: u32 = 6u32;
pub const KHR_PRESENT_WAIT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_present_wait\0")
};
...
pub const NV_COOPERATIVE_MATRIX_NAME: &CStr = unsafe {
...
pub const NV_COVERAGE_REDUCTION_MODE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_coverage_reduction_mode\0")
};
...
pub const EXT_FRAGMENT_SHADER_INTERLOCK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_fragment_shader_interlock\0")
};
pub const EXT_FRAGMENT_SHADER_INTERLOCK_SPEC_VERSION: u32 = 1u32;
pub const EXT_YCBCR_IMAGE_ARRAYS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_ycbcr_image_arrays\0")
};
pub const EXT_YCBCR_IMAGE_ARRAYS_SPEC_VERSION: u32 = 1u32;
pub const KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_uniform_buffer_standard_layout\0")
};
pub const KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_SPEC_VERSION: u32 = 1u32;
pub const EXT_PROVOKING_VERTEX_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_provoking_vertex\0")
};
pub const EXT_PROVOKING_VERTEX_SPEC_VERSION: u32 = 1u32;
pub const EXT_FULL_SCREEN_EXCLUSIVE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_full_screen_exclusive\0")
};
...
pub const EXT_HEADLESS_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_headless_surface\0")
};
...
pub const KHR_BUFFER_DEVICE_ADDRESS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_buffer_device_address\0")
};
...
pub const EXT_LINE_RASTERIZATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_line_rasterization\0")
};
...
pub const EXT_SHADER_ATOMIC_FLOAT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_atomic_float\0")
};
pub const EXT_SHADER_ATOMIC_FLOAT_SPEC_VERSION: u32 = 1u32;
pub const EXT_HOST_QUERY_RESET_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_host_query_reset\0")
};
...
pub const EXT_INDEX_TYPE_UINT8_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_index_type_uint8\0")
};
pub const EXT_INDEX_TYPE_UINT8_SPEC_VERSION: u32 = 1u32;
pub const EXT_EXTENDED_DYNAMIC_STATE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_extended_dynamic_state\0")
};
...
pub const KHR_DEFERRED_HOST_OPERATIONS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_deferred_host_operations\0")
};
...
pub const KHR_PIPELINE_EXECUTABLE_PROPERTIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_pipeline_executable_properties\0")
};
...
pub const EXT_HOST_IMAGE_COPY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_host_image_copy\0")
};
...
pub const KHR_MAP_MEMORY2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_map_memory2\0")
};
...
pub const EXT_MAP_MEMORY_PLACED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_map_memory_placed\0")
};
pub const EXT_MAP_MEMORY_PLACED_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_ATOMIC_FLOAT2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_atomic_float2\0")
};
pub const EXT_SHADER_ATOMIC_FLOAT2_SPEC_VERSION: u32 = 1u32;
pub const EXT_SURFACE_MAINTENANCE1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_surface_maintenance1\0")
};
pub const EXT_SURFACE_MAINTENANCE1_SPEC_VERSION: u32 = 1u32;
pub const EXT_SWAPCHAIN_MAINTENANCE1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_swapchain_maintenance1\0")
};
...
pub const EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_demote_to_helper_invocation\0")
};
pub const EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_SPEC_VERSION: u32 = 1u32;
pub const NV_DEVICE_GENERATED_COMMANDS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_device_generated_commands\0")
};
...
pub const NV_INHERITED_VIEWPORT_SCISSOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_inherited_viewport_scissor\0")
};
pub const NV_INHERITED_VIEWPORT_SCISSOR_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_INTEGER_DOT_PRODUCT_NAME: &CStr = unsafe {
...
pub const EXT_TEXEL_BUFFER_ALIGNMENT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_texel_buffer_alignment\0")
};
pub const EXT_TEXEL_BUFFER_ALIGNMENT_SPEC_VERSION: u32 = 1u32;
pub const QCOM_RENDER_PASS_TRANSFORM_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_render_pass_transform\0")
};
pub const QCOM_RENDER_PASS_TRANSFORM_SPEC_VERSION: u32 = 5u32;
pub const EXT_DEPTH_BIAS_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_depth_bias_control\0")
};
...
pub const EXT_DEVICE_MEMORY_REPORT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_device_memory_report\0")
};
pub const EXT_DEVICE_MEMORY_REPORT_SPEC_VERSION: u32 = 2u32;
pub const EXT_ACQUIRE_DRM_DISPLAY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_acquire_drm_display\0")
};
...
pub const KHR_PIPELINE_LIBRARY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_pipeline_library\0")
};
pub const KHR_PIPELINE_LIBRARY_SPEC_VERSION: u32 = 1u32;
pub const NV_PRESENT_BARRIER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_present_barrier\0")
};
pub const NV_PRESENT_BARRIER_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_NON_SEMANTIC_INFO_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_non_semantic_info\0")
};
pub const KHR_SHADER_NON_SEMANTIC_INFO_SPEC_VERSION: u32 = 1u32;
pub const KHR_PRESENT_ID_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_present_id\0")
};
pub const KHR_PRESENT_ID_SPEC_VERSION: u32 = 1u32;
pub const EXT_PRIVATE_DATA_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_private_data\0")
};
...
pub const EXT_PIPELINE_CREATION_CACHE_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pipeline_creation_cache_control\0")
};
pub const EXT_PIPELINE_CREATION_CACHE_CONTROL_SPEC_VERSION: u32 = 3u32;
pub const KHR_VIDEO_ENCODE_QUEUE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_encode_queue\0")
};
...
pub const NV_DEVICE_DIAGNOSTICS_CONFIG_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_device_diagnostics_config\0")
};
pub const NV_DEVICE_DIAGNOSTICS_CONFIG_SPEC_VERSION: u32 = 2u32;
pub const QCOM_RENDER_PASS_STORE_OPS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_render_pass_store_ops\0")
};
pub const QCOM_RENDER_PASS_STORE_OPS_SPEC_VERSION: u32 = 2u32;
pub const NV_CUDA_KERNEL_LAUNCH_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_cuda_kernel_launch\0")
};
...
pub const QCOM_TILE_SHADING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_tile_shading\0")
};
pub const QCOM_TILE_SHADING_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
...
pub const NV_LOW_LATENCY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_low_latency\0")
};
pub const NV_LOW_LATENCY_SPEC_VERSION: u32 = 1u32;
pub const EXT_METAL_OBJECTS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_metal_objects\0")
};
...
pub const KHR_SYNCHRONIZATION2_NAME: &CStr = unsafe {
...
pub const EXT_DESCRIPTOR_BUFFER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_descriptor_buffer\0")
};
...
pub const EXT_GRAPHICS_PIPELINE_LIBRARY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_graphics_pipeline_library\0")
};
...
pub const KHR_FRAGMENT_SHADER_BARYCENTRIC_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_fragment_shader_barycentric\0")
};
...
pub const KHR_ZERO_INITIALIZE_WORKGROUP_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_zero_initialize_workgroup_memory\0")
};
pub const KHR_ZERO_INITIALIZE_WORKGROUP_MEMORY_SPEC_VERSION: u32 = 1u32;
pub const NV_FRAGMENT_SHADING_RATE_ENUMS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_fragment_shading_rate_enums\0")
};
...
pub const NV_RAY_TRACING_MOTION_BLUR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_ray_tracing_motion_blur\0")
};
pub const NV_RAY_TRACING_MOTION_BLUR_SPEC_VERSION: u32 = 1u32;
pub const EXT_MESH_SHADER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_mesh_shader\0")
};
...
pub const EXT_YCBCR_2PLANE_444_FORMATS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_ycbcr_2plane_444_formats\0")
};
pub const EXT_YCBCR_2PLANE_444_FORMATS_SPEC_VERSION: u32 = 1u32;
pub const EXT_FRAGMENT_DENSITY_MAP2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_fragment_density_map2\0")
};
pub const EXT_FRAGMENT_DENSITY_MAP2_SPEC_VERSION: u32 = 1u32;
pub const QCOM_ROTATED_COPY_COMMANDS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_rotated_copy_commands\0")
};
pub const QCOM_ROTATED_COPY_COMMANDS_SPEC_VERSION: u32 = 2u32;
pub const EXT_IMAGE_ROBUSTNESS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_robustness\0")
};
pub const EXT_IMAGE_ROBUSTNESS_SPEC_VERSION: u32 = 1u32;
pub const KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_workgroup_memory_explicit_layout\0")
};
pub const KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_SPEC_VERSION: u32 = 1u32;
pub const KHR_COPY_COMMANDS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_copy_commands2\0")
};
...
pub const EXT_IMAGE_COMPRESSION_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_compression_control\0")
};
pub const EXT_IMAGE_COMPRESSION_CONTROL_SPEC_VERSION: u32 = 1u32;
pub const EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_attachment_feedback_loop_layout\0")
};
pub const EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_SPEC_VERSION: u32 = 2u32;
pub const EXT_4444_FORMATS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_4444_formats\0")
};
pub const EXT_4444_FORMATS_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEVICE_FAULT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_device_fault\0")
};
...
pub const EXT_RGBA10X6_FORMATS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_rgba10x6_formats\0")
};
pub const EXT_RGBA10X6_FORMATS_SPEC_VERSION: u32 = 1u32;
pub const NV_ACQUIRE_WINRT_DISPLAY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_acquire_winrt_display\0")
};
...
pub const EXT_DIRECTFB_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_directfb_surface\0")
};
...
pub const VALVE_MUTABLE_DESCRIPTOR_TYPE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_VALVE_mutable_descriptor_type\0")
};
pub const VALVE_MUTABLE_DESCRIPTOR_TYPE_SPEC_VERSION: u32 = 1u32;
pub const EXT_VERTEX_INPUT_DYNAMIC_STATE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_vertex_input_dynamic_state\0")
};
...
pub const EXT_PHYSICAL_DEVICE_DRM_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_physical_device_drm\0")
};
pub const EXT_PHYSICAL_DEVICE_DRM_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEVICE_ADDRESS_BINDING_REPORT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_device_address_binding_report\0")
};
pub const EXT_DEVICE_ADDRESS_BINDING_REPORT_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEPTH_CLIP_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_depth_clip_control\0")
};
pub const EXT_DEPTH_CLIP_CONTROL_SPEC_VERSION: u32 = 1u32;
pub const EXT_PRIMITIVE_TOPOLOGY_LIST_RESTART_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_primitive_topology_list_restart\0")
};
pub const EXT_PRIMITIVE_TOPOLOGY_LIST_RESTART_SPEC_VERSION: u32 = 1u32;
pub const KHR_FORMAT_FEATURE_FLAGS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_format_feature_flags2\0")
};
pub const KHR_FORMAT_FEATURE_FLAGS2_SPEC_VERSION: u32 = 2u32;
pub const EXT_PRESENT_MODE_FIFO_LATEST_READY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_present_mode_fifo_latest_ready\0")
};
pub const EXT_PRESENT_MODE_FIFO_LATEST_READY_SPEC_VERSION: u32 = 1u32;
pub const FUCHSIA_EXTERNAL_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_FUCHSIA_external_memory\0")
};
...
pub const FUCHSIA_EXTERNAL_SEMAPHORE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_FUCHSIA_external_semaphore\0")
};
...
pub const FUCHSIA_BUFFER_COLLECTION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_FUCHSIA_buffer_collection\0")
};
...
pub const HUAWEI_SUBPASS_SHADING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_HUAWEI_subpass_shading\0")
};
...
pub const HUAWEI_INVOCATION_MASK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_HUAWEI_invocation_mask\0")
};
...
pub const NV_EXTERNAL_MEMORY_RDMA_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_external_memory_rdma\0")
};
...
pub const EXT_PIPELINE_PROPERTIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pipeline_properties\0")
};
...
pub const EXT_FRAME_BOUNDARY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_frame_boundary\0")
};
...
pub const EXT_EXTENDED_DYNAMIC_STATE2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_extended_dynamic_state2\0")
};
...
pub const QNX_SCREEN_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QNX_screen_surface\0")
};
...
pub const EXT_COLOR_WRITE_ENABLE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_color_write_enable\0")
};
...
pub const EXT_PRIMITIVES_GENERATED_QUERY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_primitives_generated_query\0")
};
pub const EXT_PRIMITIVES_GENERATED_QUERY_SPEC_VERSION: u32 = 1u32;
pub const KHR_RAY_TRACING_MAINTENANCE1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_ray_tracing_maintenance1\0")
};
...
pub const EXT_GLOBAL_PRIORITY_QUERY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_global_priority_query\0")
};
pub const EXT_GLOBAL_PRIORITY_QUERY_SPEC_VERSION: u32 = 1u32;
pub const EXT_IMAGE_VIEW_MIN_LOD_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_view_min_lod\0")
};
pub const EXT_IMAGE_VIEW_MIN_LOD_SPEC_VERSION: u32 = 1u32;
pub const EXT_MULTI_DRAW_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_multi_draw\0")
};
...
pub const EXT_IMAGE_2D_VIEW_OF_3D_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_2d_view_of_3d\0")
};
pub const EXT_IMAGE_2D_VIEW_OF_3D_SPEC_VERSION: u32 = 1u32;
pub const KHR_PORTABILITY_ENUMERATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_portability_enumeration\0")
};
pub const KHR_PORTABILITY_ENUMERATION_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_TILE_IMAGE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_tile_image\0")
};
pub const EXT_SHADER_TILE_IMAGE_SPEC_VERSION: u32 = 1u32;
pub const EXT_OPACITY_MICROMAP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_opacity_micromap\0")
};
...
pub const NV_DISPLACEMENT_MICROMAP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_displacement_micromap\0")
};
pub const NV_DISPLACEMENT_MICROMAP_SPEC_VERSION: u32 = 2u32;
pub const EXT_LOAD_STORE_OP_NONE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_load_store_op_none\0")
};
pub const EXT_LOAD_STORE_OP_NONE_SPEC_VERSION: u32 = 1u32;
pub const HUAWEI_CLUSTER_CULLING_SHADER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_HUAWEI_cluster_culling_shader\0")
};
...
pub const EXT_BORDER_COLOR_SWIZZLE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_border_color_swizzle\0")
};
pub const EXT_BORDER_COLOR_SWIZZLE_SPEC_VERSION: u32 = 1u32;
pub const EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pageable_device_local_memory\0")
};
...
pub const KHR_MAINTENANCE4_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance4\0")
};
...
pub const ARM_SHADER_CORE_PROPERTIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_shader_core_properties\0")
};
pub const ARM_SHADER_CORE_PROPERTIES_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_SUBGROUP_ROTATE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_subgroup_rotate\0")
};
pub const KHR_SHADER_SUBGROUP_ROTATE_SPEC_VERSION: u32 = 2u32;
pub const ARM_SCHEDULING_CONTROLS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_scheduling_controls\0")
};
pub const ARM_SCHEDULING_CONTROLS_SPEC_VERSION: u32 = 1u32;
pub const EXT_IMAGE_SLICED_VIEW_OF_3D_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_sliced_view_of_3d\0")
};
pub const EXT_IMAGE_SLICED_VIEW_OF_3D_SPEC_VERSION: u32 = 1u32;
pub const VALVE_DESCRIPTOR_SET_HOST_MAPPING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_VALVE_descriptor_set_host_mapping\0")
};
...
pub const EXT_DEPTH_CLAMP_ZERO_ONE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_depth_clamp_zero_one\0")
};
pub const EXT_DEPTH_CLAMP_ZERO_ONE_SPEC_VERSION: u32 = 1u32;
pub const EXT_NON_SEAMLESS_CUBE_MAP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_non_seamless_cube_map\0")
};
pub const EXT_NON_SEAMLESS_CUBE_MAP_SPEC_VERSION: u32 = 1u32;
pub const ARM_RENDER_PASS_STRIPED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_render_pass_striped\0")
};
pub const ARM_RENDER_PASS_STRIPED_SPEC_VERSION: u32 = 1u32;
pub const QCOM_FRAGMENT_DENSITY_MAP_OFFSET_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_fragment_density_map_offset\0")
};
pub const QCOM_FRAGMENT_DENSITY_MAP_OFFSET_SPEC_VERSION: u32 = 3u32;
pub const NV_COPY_MEMORY_INDIRECT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_copy_memory_indirect\0")
};
...
pub const NV_MEMORY_DECOMPRESSION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_memory_decompression\0")
};
...
pub const NV_DEVICE_GENERATED_COMMANDS_COMPUTE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_device_generated_commands_compute\0")
};
...
pub const NV_RAY_TRACING_LINEAR_SWEPT_SPHERES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_ray_tracing_linear_swept_spheres\0")
};
pub const NV_RAY_TRACING_LINEAR_SWEPT_SPHERES_SPEC_VERSION: u32 = 1u32;
pub const NV_LINEAR_COLOR_ATTACHMENT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_linear_color_attachment\0")
};
pub const NV_LINEAR_COLOR_ATTACHMENT_SPEC_VERSION: u32 = 1u32;
pub const GOOGLE_SURFACELESS_QUERY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_GOOGLE_surfaceless_query\0")
};
pub const GOOGLE_SURFACELESS_QUERY_SPEC_VERSION: u32 = 2u32;
pub const KHR_SHADER_MAXIMAL_RECONVERGENCE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_maximal_reconvergence\0")
};
pub const KHR_SHADER_MAXIMAL_RECONVERGENCE_SPEC_VERSION: u32 = 1u32;
pub const EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_image_compression_control_swapchain\0")
};
pub const EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_SPEC_VERSION: u32 = 1u32;
pub const QCOM_IMAGE_PROCESSING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_image_processing\0")
};
pub const QCOM_IMAGE_PROCESSING_SPEC_VERSION: u32 = 1u32;
pub const EXT_NESTED_COMMAND_BUFFER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_nested_command_buffer\0")
};
pub const EXT_NESTED_COMMAND_BUFFER_SPEC_VERSION: u32 = 1u32;
pub const EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_external_memory_acquire_unmodified\0")
};
pub const EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_SPEC_VERSION: u32 = 1u32;
pub const EXT_EXTENDED_DYNAMIC_STATE3_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_extended_dynamic_state3\0")
};
...
pub const EXT_SUBPASS_MERGE_FEEDBACK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_subpass_merge_feedback\0")
};
pub const EXT_SUBPASS_MERGE_FEEDBACK_SPEC_VERSION: u32 = 2u32;
pub const LUNARG_DIRECT_DRIVER_LOADING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_LUNARG_direct_driver_loading\0")
};
pub const LUNARG_DIRECT_DRIVER_LOADING_SPEC_VERSION: u32 = 1u32;
pub const ARM_TENSORS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_tensors\0")
};
...
pub const EXT_SHADER_MODULE_IDENTIFIER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_module_identifier\0")
};
...
pub const NV_OPTICAL_FLOW_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_optical_flow\0")
};
...
pub const EXT_LEGACY_DITHERING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_legacy_dithering\0")
};
pub const EXT_LEGACY_DITHERING_SPEC_VERSION: u32 = 2u32;
pub const EXT_PIPELINE_PROTECTED_ACCESS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pipeline_protected_access\0")
};
pub const EXT_PIPELINE_PROTECTED_ACCESS_SPEC_VERSION: u32 = 1u32;
pub const ANDROID_EXTERNAL_FORMAT_RESOLVE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ANDROID_external_format_resolve\0")
};
pub const ANDROID_EXTERNAL_FORMAT_RESOLVE_SPEC_VERSION: u32 = 1u32;
pub const KHR_MAINTENANCE5_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance5\0")
};
...
pub const AMD_ANTI_LAG_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_AMD_anti_lag\0")
};
pub const AMD_ANTI_LAG_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
pub type PFN_vkAntiLagUpdateAMD = unsafe extern "system" fn(
    device: ash::vk::Device,
    p_data: *const AntiLagDataAMD<'_>,
);
pub const KHR_PRESENT_ID2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_present_id2\0")
};
pub const KHR_PRESENT_ID2_SPEC_VERSION: u32 = 1u32;
pub const KHR_PRESENT_WAIT2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_present_wait2\0")
};
pub const KHR_PRESENT_WAIT2_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
...
pub const KHR_RAY_TRACING_POSITION_FETCH_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_ray_tracing_position_fetch\0")
};
pub const KHR_RAY_TRACING_POSITION_FETCH_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_OBJECT_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_object\0")
};
...
pub const KHR_PIPELINE_BINARY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_pipeline_binary\0")
};
...
pub const QCOM_TILE_PROPERTIES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_tile_properties\0")
};
...
pub const SEC_AMIGO_PROFILING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_SEC_amigo_profiling\0")
};
pub const SEC_AMIGO_PROFILING_SPEC_VERSION: u32 = 1u32;
pub const KHR_SURFACE_MAINTENANCE1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_surface_maintenance1\0")
};
pub const KHR_SURFACE_MAINTENANCE1_SPEC_VERSION: u32 = 1u32;
pub const KHR_SWAPCHAIN_MAINTENANCE1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_swapchain_maintenance1\0")
};
pub const KHR_SWAPCHAIN_MAINTENANCE1_SPEC_VERSION: u32 = 1u32;
pub const QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_multiview_per_view_viewports\0")
};
pub const QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_SPEC_VERSION: u32 = 1u32;
pub const NV_RAY_TRACING_INVOCATION_REORDER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_ray_tracing_invocation_reorder\0")
};
pub const NV_RAY_TRACING_INVOCATION_REORDER_SPEC_VERSION: u32 = 1u32;
pub const NV_COOPERATIVE_VECTOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_cooperative_vector\0")
};
...
pub const NV_EXTENDED_SPARSE_ADDRESS_SPACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_extended_sparse_address_space\0")
};
pub const NV_EXTENDED_SPARSE_ADDRESS_SPACE_SPEC_VERSION: u32 = 1u32;
pub const EXT_MUTABLE_DESCRIPTOR_TYPE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_mutable_descriptor_type\0")
};
pub const EXT_MUTABLE_DESCRIPTOR_TYPE_SPEC_VERSION: u32 = 1u32;
pub const EXT_LEGACY_VERTEX_ATTRIBUTES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_legacy_vertex_attributes\0")
};
pub const EXT_LEGACY_VERTEX_ATTRIBUTES_SPEC_VERSION: u32 = 1u32;
pub const EXT_LAYER_SETTINGS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_layer_settings\0")
};
pub const EXT_LAYER_SETTINGS_SPEC_VERSION: u32 = 2u32;
pub const ARM_SHADER_CORE_BUILTINS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_shader_core_builtins\0")
};
pub const ARM_SHADER_CORE_BUILTINS_SPEC_VERSION: u32 = 2u32;
pub const EXT_PIPELINE_LIBRARY_GROUP_HANDLES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_pipeline_library_group_handles\0")
};
...
pub const KHR_COOPERATIVE_MATRIX_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_cooperative_matrix\0")
};
...
pub const ARM_DATA_GRAPH_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_data_graph\0")
};
pub const ARM_DATA_GRAPH_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
...
pub const QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_multiview_per_view_render_areas\0")
};
pub const QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_SPEC_VERSION: u32 = 1u32;
pub const KHR_COMPUTE_SHADER_DERIVATIVES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_compute_shader_derivatives\0")
};
pub const KHR_COMPUTE_SHADER_DERIVATIVES_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_DECODE_AV1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_decode_av1\0")
};
pub const KHR_VIDEO_DECODE_AV1_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_ENCODE_AV1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_encode_av1\0")
};
pub const KHR_VIDEO_ENCODE_AV1_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_DECODE_VP9_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_decode_vp9\0")
};
pub const KHR_VIDEO_DECODE_VP9_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_MAINTENANCE1_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_maintenance1\0")
};
pub const KHR_VIDEO_MAINTENANCE1_SPEC_VERSION: u32 = 1u32;
pub const NV_PER_STAGE_DESCRIPTOR_SET_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_per_stage_descriptor_set\0")
};
pub const NV_PER_STAGE_DESCRIPTOR_SET_SPEC_VERSION: u32 = 1u32;
pub const QCOM_IMAGE_PROCESSING2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_image_processing2\0")
};
pub const QCOM_IMAGE_PROCESSING2_SPEC_VERSION: u32 = 1u32;
pub const QCOM_FILTER_CUBIC_WEIGHTS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_filter_cubic_weights\0")
};
pub const QCOM_FILTER_CUBIC_WEIGHTS_SPEC_VERSION: u32 = 1u32;
pub const QCOM_YCBCR_DEGAMMA_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_ycbcr_degamma\0")
};
pub const QCOM_YCBCR_DEGAMMA_SPEC_VERSION: u32 = 1u32;
pub const QCOM_FILTER_CUBIC_CLAMP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_filter_cubic_clamp\0")
};
...
pub const KHR_VERTEX_ATTRIBUTE_DIVISOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_vertex_attribute_divisor\0")
};
pub const KHR_VERTEX_ATTRIBUTE_DIVISOR_SPEC_VERSION: u32 = 1u32;
pub const KHR_LOAD_STORE_OP_NONE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_load_store_op_none\0")
};
pub const KHR_LOAD_STORE_OP_NONE_SPEC_VERSION: u32 = 1u32;
pub const KHR_UNIFIED_IMAGE_LAYOUTS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_unified_image_layouts\0")
};
pub const KHR_UNIFIED_IMAGE_LAYOUTS_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_FLOAT_CONTROLS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_float_controls2\0")
};
pub const KHR_SHADER_FLOAT_CONTROLS2_SPEC_VERSION: u32 = 1u32;
pub const QNX_EXTERNAL_MEMORY_SCREEN_BUFFER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QNX_external_memory_screen_buffer\0")
};
...
pub const MSFT_LAYERED_DRIVER_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_MSFT_layered_driver\0")
};
pub const MSFT_LAYERED_DRIVER_SPEC_VERSION: u32 = 1u32;
pub const KHR_INDEX_TYPE_UINT8_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_index_type_uint8\0")
};
pub const KHR_INDEX_TYPE_UINT8_SPEC_VERSION: u32 = 1u32;
pub const KHR_LINE_RASTERIZATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_line_rasterization\0")
};
pub const KHR_LINE_RASTERIZATION_SPEC_VERSION: u32 = 1u32;
pub const KHR_CALIBRATED_TIMESTAMPS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_calibrated_timestamps\0")
};
pub const KHR_CALIBRATED_TIMESTAMPS_SPEC_VERSION: u32 = 1u32;
pub const KHR_SHADER_EXPECT_ASSUME_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_expect_assume\0")
};
pub const KHR_SHADER_EXPECT_ASSUME_SPEC_VERSION: u32 = 1u32;
pub const KHR_MAINTENANCE6_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance6\0")
};
...
pub const NV_DESCRIPTOR_POOL_OVERALLOCATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_descriptor_pool_overallocation\0")
};
pub const NV_DESCRIPTOR_POOL_OVERALLOCATION_SPEC_VERSION: u32 = 1u32;
pub const QCOM_TILE_MEMORY_HEAP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_QCOM_tile_memory_heap\0")
};
pub const QCOM_TILE_MEMORY_HEAP_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
pub type PFN_vkCmdBindTileMemoryQCOM = unsafe extern "system" fn(
    command_buffer: CommandBuffer,
    p_tile_memory_bind_info: *const TileMemoryBindInfoQCOM<'_>,
);
pub const NV_DISPLAY_STEREO_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_display_stereo\0")
};
pub const NV_DISPLAY_STEREO_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_ENCODE_INTRA_REFRESH_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_encode_intra_refresh\0")
};
pub const KHR_VIDEO_ENCODE_INTRA_REFRESH_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_ENCODE_QUANTIZATION_MAP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_encode_quantization_map\0")
};
pub const KHR_VIDEO_ENCODE_QUANTIZATION_MAP_SPEC_VERSION: u32 = 2u32;
pub const NV_RAW_ACCESS_CHAINS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_raw_access_chains\0")
};
pub const NV_RAW_ACCESS_CHAINS_SPEC_VERSION: u32 = 1u32;
pub const NV_EXTERNAL_COMPUTE_QUEUE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_external_compute_queue\0")
};
pub const NV_EXTERNAL_COMPUTE_QUEUE_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
...
pub const KHR_SHADER_RELAXED_EXTENDED_INSTRUCTION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_shader_relaxed_extended_instruction\0")
};
pub const KHR_SHADER_RELAXED_EXTENDED_INSTRUCTION_SPEC_VERSION: u32 = 1u32;
pub const NV_COMMAND_BUFFER_INHERITANCE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_command_buffer_inheritance\0")
};
pub const NV_COMMAND_BUFFER_INHERITANCE_SPEC_VERSION: u32 = 1u32;
pub const KHR_MAINTENANCE7_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance7\0")
};
pub const KHR_MAINTENANCE7_SPEC_VERSION: u32 = 1u32;
pub const NV_SHADER_ATOMIC_FLOAT16_VECTOR_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_shader_atomic_float16_vector\0")
};
pub const NV_SHADER_ATOMIC_FLOAT16_VECTOR_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_REPLICATED_COMPOSITES_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_replicated_composites\0")
};
pub const EXT_SHADER_REPLICATED_COMPOSITES_SPEC_VERSION: u32 = 1u32;
pub const EXT_SHADER_FLOAT8_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_shader_float8\0")
};
pub const EXT_SHADER_FLOAT8_SPEC_VERSION: u32 = 1u32;
pub const NV_RAY_TRACING_VALIDATION_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_ray_tracing_validation\0")
};
pub const NV_RAY_TRACING_VALIDATION_SPEC_VERSION: u32 = 1u32;
pub const NV_CLUSTER_ACCELERATION_STRUCTURE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_cluster_acceleration_structure\0")
};
pub const NV_CLUSTER_ACCELERATION_STRUCTURE_SPEC_VERSION: u32 = 3u32;
#[allow(non_camel_case_types)]
...
pub const NV_PARTITIONED_ACCELERATION_STRUCTURE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_partitioned_acceleration_structure\0")
};
...
pub const EXT_DEVICE_GENERATED_COMMANDS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_device_generated_commands\0")
};
...
pub const KHR_MAINTENANCE8_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance8\0")
};
pub const KHR_MAINTENANCE8_SPEC_VERSION: u32 = 1u32;
pub const MESA_IMAGE_ALIGNMENT_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_MESA_image_alignment_control\0")
};
pub const MESA_IMAGE_ALIGNMENT_CONTROL_SPEC_VERSION: u32 = 1u32;
pub const EXT_DEPTH_CLAMP_CONTROL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_depth_clamp_control\0")
};
pub const EXT_DEPTH_CLAMP_CONTROL_SPEC_VERSION: u32 = 1u32;
pub const KHR_MAINTENANCE9_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_maintenance9\0")
};
pub const KHR_MAINTENANCE9_SPEC_VERSION: u32 = 1u32;
pub const KHR_VIDEO_MAINTENANCE2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_video_maintenance2\0")
};
pub const KHR_VIDEO_MAINTENANCE2_SPEC_VERSION: u32 = 1u32;
pub const OHOS_SURFACE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_OHOS_surface\0")
};
pub const OHOS_SURFACE_SPEC_VERSION: u32 = 1u32;
#[allow(non_camel_case_types)]
...
pub const NV_COOPERATIVE_MATRIX2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_cooperative_matrix2\0")
};
...
pub const ARM_PIPELINE_OPACITY_MICROMAP_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_pipeline_opacity_micromap\0")
};
pub const ARM_PIPELINE_OPACITY_MICROMAP_SPEC_VERSION: u32 = 1u32;
pub const EXT_EXTERNAL_MEMORY_METAL_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_external_memory_metal\0")
};
...
pub const KHR_DEPTH_CLAMP_ZERO_ONE_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_depth_clamp_zero_one\0")
};
pub const KHR_DEPTH_CLAMP_ZERO_ONE_SPEC_VERSION: u32 = 1u32;
pub const EXT_VERTEX_ATTRIBUTE_ROBUSTNESS_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_vertex_attribute_robustness\0")
};
pub const EXT_VERTEX_ATTRIBUTE_ROBUSTNESS_SPEC_VERSION: u32 = 1u32;
pub const ARM_FORMAT_PACK_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_ARM_format_pack\0")
};
pub const ARM_FORMAT_PACK_SPEC_VERSION: u32 = 1u32;
pub const VALVE_FRAGMENT_DENSITY_MAP_LAYERED_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_VALVE_fragment_density_map_layered\0")
};
pub const VALVE_FRAGMENT_DENSITY_MAP_LAYERED_SPEC_VERSION: u32 = 1u32;
pub const KHR_ROBUSTNESS2_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_robustness2\0")
};
pub const KHR_ROBUSTNESS2_SPEC_VERSION: u32 = 1u32;
pub const NV_PRESENT_METERING_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_NV_present_metering\0")
};
pub const NV_PRESENT_METERING_SPEC_VERSION: u32 = 1u32;
pub const EXT_FRAGMENT_DENSITY_MAP_OFFSET_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_fragment_density_map_offset\0")
};
...
pub const EXT_ZERO_INITIALIZE_DEVICE_MEMORY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_EXT_zero_initialize_device_memory\0")
};
pub const EXT_ZERO_INITIALIZE_DEVICE_MEMORY_SPEC_VERSION: u32 = 1u32;
pub const KHR_PRESENT_MODE_FIFO_LATEST_READY_NAME: &CStr = unsafe {
    CStr::from_bytes_with_nul_unchecked(b"VK_KHR_present_mode_fifo_latest_ready\0")
};
