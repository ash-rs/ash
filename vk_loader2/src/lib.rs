...
use std::ops::*;
use std::fmt; use std::ffi::CStr; use super::*; #[allow(unused_imports)]use super::libc_reexports::*;
pub type c_void = ();
pub type c_char = i8;
...
pub const FORMAT_FEATURE_STORAGE_IMAGE_ATOMIC_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b100};
pub const FORMAT_FEATURE_UNIFORM_TEXEL_BUFFER_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b1000};
pub const FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b10000};
pub const FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_ATOMIC_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b100000};
pub const FORMAT_FEATURE_VERTEX_BUFFER_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b1000000};
pub const FORMAT_FEATURE_COLOR_ATTACHMENT_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b10000000};
pub const FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b100000000};
pub const FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b1000000000};
pub const FORMAT_FEATURE_BLIT_SRC_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b10000000000};
pub const FORMAT_FEATURE_BLIT_DST_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b100000000000};
pub const FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT: FormatFeatureFlags = FormatFeatureFlags {flags: 0b1000000000000};
...
pub const IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT: ImageUsageFlags = ImageUsageFlags {flags: 0b100000};
pub const IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT: ImageUsageFlags = ImageUsageFlags {flags: 0b1000000};
...
pub const MEMORY_PROPERTY_DEVICE_LOCAL_BIT: MemoryPropertyFlags = MemoryPropertyFlags {flags: 0b1};
pub const MEMORY_PROPERTY_HOST_VISIBLE_BIT: MemoryPropertyFlags = MemoryPropertyFlags {flags: 0b10};
pub const MEMORY_PROPERTY_HOST_COHERENT_BIT: MemoryPropertyFlags = MemoryPropertyFlags {flags: 0b100};
pub const MEMORY_PROPERTY_HOST_CACHED_BIT: MemoryPropertyFlags = MemoryPropertyFlags {flags: 0b1000};
pub const MEMORY_PROPERTY_LAZILY_ALLOCATED_BIT: MemoryPropertyFlags = MemoryPropertyFlags {flags: 0b10000};
...
pub const PIPELINE_STAGE_VERTEX_SHADER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b1000};
pub const PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b10000};
pub const PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b100000};
pub const PIPELINE_STAGE_GEOMETRY_SHADER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b1000000};
pub const PIPELINE_STAGE_FRAGMENT_SHADER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b10000000};
pub const PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b100000000};
pub const PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b1000000000};
pub const PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b10000000000};
pub const PIPELINE_STAGE_COMPUTE_SHADER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b100000000000};
pub const PIPELINE_STAGE_TRANSFER_BIT: PipelineStageFlags = PipelineStageFlags {flags: 0b1000000000000};
...
pub const SPARSE_IMAGE_FORMAT_SINGLE_MIPTAIL_BIT: SparseImageFormatFlags = SparseImageFormatFlags {flags: 0b1};
pub const SPARSE_IMAGE_FORMAT_ALIGNED_MIP_SIZE_BIT: SparseImageFormatFlags = SparseImageFormatFlags {flags: 0b10};
pub const SPARSE_IMAGE_FORMAT_NONSTANDARD_BLOCK_SIZE_BIT: SparseImageFormatFlags = SparseImageFormatFlags {flags: 0b100};
vk_bitflags_wrapped!(SparseImageFormatFlags, 0b111, Flags);

pub const SPARSE_MEMORY_BIND_METADATA_BIT: SparseMemoryBindFlags = SparseMemoryBindFlags {flags: 0b1};
...
pub const QUERY_PIPELINE_STATISTIC_INPUT_ASSEMBLY_VERTICES_BIT: QueryPipelineStatisticFlags = QueryPipelineStatisticFlags {flags: 0b1};
...
pub const QUERY_PIPELINE_STATISTIC_CLIPPING_INVOCATIONS_BIT: QueryPipelineStatisticFlags = QueryPipelineStatisticFlags {flags: 0b100000};
pub const QUERY_PIPELINE_STATISTIC_CLIPPING_PRIMITIVES_BIT: QueryPipelineStatisticFlags = QueryPipelineStatisticFlags {flags: 0b1000000};
...
pub const BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT: BufferUsageFlags = BufferUsageFlags {flags: 0b100};
pub const BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT: BufferUsageFlags = BufferUsageFlags {flags: 0b1000};
...
pub const BUFFER_USAGE_INDIRECT_BUFFER_BIT: BufferUsageFlags = BufferUsageFlags {flags: 0b100000000};
vk_bitflags_wrapped!(BufferUsageFlags, 0b111111111, Flags);

pub const PIPELINE_CREATE_DISABLE_OPTIMIZATION_BIT: PipelineCreateFlags = PipelineCreateFlags {flags: 0b1};
pub const PIPELINE_CREATE_ALLOW_DERIVATIVES_BIT: PipelineCreateFlags = PipelineCreateFlags {flags: 0b10};
pub const PIPELINE_CREATE_DERIVATIVE_BIT: PipelineCreateFlags = PipelineCreateFlags {flags: 0b100};
...
pub const SHADER_STAGE_TESSELLATION_CONTROL_BIT: ShaderStageFlags = ShaderStageFlags {flags: 0b10};
pub const SHADER_STAGE_TESSELLATION_EVALUATION_BIT: ShaderStageFlags = ShaderStageFlags {flags: 0b100};
...
pub const SHADER_STAGE_ALL: ShaderStageFlags = ShaderStageFlags {flags: 0b1111111111111111111111111111111};
...
pub const DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET_BIT: DescriptorPoolCreateFlags = DescriptorPoolCreateFlags {flags: 0b1};
vk_bitflags_wrapped!(DescriptorPoolCreateFlags, 0b1, Flags);

pub const ATTACHMENT_DESCRIPTION_MAY_ALIAS_BIT: AttachmentDescriptionFlags = AttachmentDescriptionFlags {flags: 0b1};
...
pub const ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT: AccessFlags = AccessFlags {flags: 0b1000000000};
pub const ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT: AccessFlags = AccessFlags {flags: 0b10000000000};
...
pub const COMMAND_POOL_CREATE_TRANSIENT_BIT: CommandPoolCreateFlags = CommandPoolCreateFlags {flags: 0b1};
pub const COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT: CommandPoolCreateFlags = CommandPoolCreateFlags {flags: 0b10};
vk_bitflags_wrapped!(CommandPoolCreateFlags, 0b11, Flags);

pub const COMMAND_POOL_RESET_RELEASE_RESOURCES_BIT: CommandPoolResetFlags = CommandPoolResetFlags {flags: 0b1};
vk_bitflags_wrapped!(CommandPoolResetFlags, 0b1, Flags);

pub const COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT: CommandBufferUsageFlags = CommandBufferUsageFlags {flags: 0b1};
pub const COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT: CommandBufferUsageFlags = CommandBufferUsageFlags {flags: 0b10};
pub const COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT: CommandBufferUsageFlags = CommandBufferUsageFlags {flags: 0b100};
...
pub const COMMAND_BUFFER_RESET_RELEASE_RESOURCES_BIT: CommandBufferResetFlags = CommandBufferResetFlags {flags: 0b1};
...
pub const SURFACE_TRANSFORM_IDENTITY_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b1};
pub const SURFACE_TRANSFORM_ROTATE_90_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b10};
pub const SURFACE_TRANSFORM_ROTATE_180_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b100};
pub const SURFACE_TRANSFORM_ROTATE_270_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b1000};
pub const SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b10000};
pub const SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b100000};
pub const SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b1000000};
pub const SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b10000000};
pub const SURFACE_TRANSFORM_INHERIT_BIT_KHR: SurfaceTransformFlagsKHR = SurfaceTransformFlagsKHR {flags: 0b100000000};
vk_bitflags_wrapped!(SurfaceTransformFlagsKHR, 0b111111111, Flags);

pub const COMPOSITE_ALPHA_OPAQUE_BIT_KHR: CompositeAlphaFlagsKHR = CompositeAlphaFlagsKHR {flags: 0b1};
pub const COMPOSITE_ALPHA_PRE_MULTIPLIED_BIT_KHR: CompositeAlphaFlagsKHR = CompositeAlphaFlagsKHR {flags: 0b10};
pub const COMPOSITE_ALPHA_POST_MULTIPLIED_BIT_KHR: CompositeAlphaFlagsKHR = CompositeAlphaFlagsKHR {flags: 0b100};
...
pub mod cmds {
#![allow(dead_code)]
use super::*; #[allow(unused_imports)] use super::libc_reexports::*;
vk_functions!{
    Static,
